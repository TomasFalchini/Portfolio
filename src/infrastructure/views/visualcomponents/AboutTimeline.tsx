...
function AboutTimeline() {
  return (
    <ul className=" font-sans p-4 lg:p-8 bg-slate-900/50">
      <li>
        <article>
          <div className="grid p-4  overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 ">
            ...
            <time
              dateTime=""
              className=" row-start-1 mb-1 font-semibold text-slate-50 md:col-start-1 xl:col-span-2 "
            >
              Feb 02, 2017
            </time>
            <p className=" p-4 ml-8 text-justify text-gray-50 md:col-start-2 md:col-span-4 xl:col-start-3 xl:col-span-9 md:ml-0 ">
